...
| 使用方式                     | 主动session管理 | 主动sessionContext管理 | 主动事务abort/commit | 便利性 |
| ---------------------------- | --------------- | ---------------------- | -------------------- | ------ |
...
就使用上来说，确实还是`python`的`pymongo`用起来更方便。

# 参考资料

1. [https://github.com/mongodb/mongo-go-driver](https://github.com/mongodb/mongo-go-driver)
2. [https://pkg.go.dev/go.mongodb.org/mongo-driver/mongo#section-documentation](https://pkg.go.dev/go.mongodb.org/mongo-driver/mongo#section-documentation)